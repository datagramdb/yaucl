 ...
 */
        struct smart_index_pointer {
            smart_malloc malloc;
            struct iovec tmp;
            std::pair<uint_fast64_t ,uint_fast64_t >* external_pointer;
            uint_fast64_t fix_block_size;
            struct std::pair<uint_fast64_t ,uint_fast64_t > unthread_safe;
             ...
             */
            smart_index_pointer(std::pair<uint_fast64_t ,uint_fast64_t > *externalPointer);
            ...
            void open(std::pair<uint_fast64_t ,uint_fast64_t >* ptr);
             ...
             * @return
             */
            std::pair<uint_fast64_t ,uint_fast64_t >* operator[](const uint_fast64_t& id);
