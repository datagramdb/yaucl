...
yaucl::memory::smart_index_pointer::smart_index_pointer(yaucl::memory::index *externalPointer) : external_pointer(externalPointer) {
    fix_block_size = 0;
}
...
void smart_index_pointer::open(yaucl::memory::index *ptr) {
    fix_block_size = 0;
